...
class TextViewDialog: ThemeDialogView {
    ...
    func initialize(title:String, message:String, data:String) {
        ...
        self.btnVerify.setTitle("BTN_SUBMIT".localized(), for: .normal)
        self.initialSetup()
    }
...
extension  TextViewDialog {
    ...
    @objc func viewPanned(recognizer: UIPanGestureRecognizer) {
        ...
        case .changed:
            let totalXSwipe: CGFloat = translate.y - yPostion
            let width: CGFloat = UIScreen.main.bounds.size.height
